/*Definir una función que recibe un parámetro de cualquier tipo y dice si es convertible a número
o no, usando la constante NaN*/


function esConvertible1(entrada: any) {
